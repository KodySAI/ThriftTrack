...
const HomePage: React.FC = () => {
  const { data } = useQuery<TransactionStatisticsResponse>(GET_TRANSACTION_STATISTICS);
  const { data: authUserData } = useQuery<AuthenticatedUserResponse>(GET_AUTHENTICATED_USER);
